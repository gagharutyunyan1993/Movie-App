...
@section('content')
    ...
    <div class="p-3 mb-2 bg-dark text-white">
        <div class="card-header">
            ...
            @if(!Auth::guest())
                <a class="btn btn-success ribbon" style="color:white;" href="{{route('movies.create')}}" role="button"
                   aria-pressed="true">Create Movies</a>
            @endif
        </div>
    </div><br/>
                ...
                <div class="col-md-3">
                    <div class="card text-center">
                        ...
                        <div class="card-body">
                            ...
                            <a href="{{route('movies.show', ['movie'=>$movie->id])}}" class="btn btn-success">Read
                                more</a>
                        </div>
                    </div>
                </div>
